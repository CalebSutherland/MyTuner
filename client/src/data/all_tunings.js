...
const tunings = {
  ...
  "Power": [
    ...
    { name: 'Drop C♯', notes: ['C♯2', 'G♯2', 'C♯3', 'F♯3', 'A♯3', 'D♯4'], values: [freq["C#2"], freq["G#2"], freq["C#3"], freq["F#3"], freq["A#3"], freq["D#4"], ] },
    { name: 'Drop C', notes: ['C2', 'G2', 'C3', 'F3', 'A3', 'D4'], values: [freq["C2"], freq["G2"], freq["C3"], freq["F3"], freq["A3"], freq["D4"], ] },
    { name: 'Drop B', notes: ['B1', 'F♯2', 'B2', 'E3', 'G♯3', 'C♯4'], values: [freq["B1"], freq["F#2"], freq["B2"], freq["E3"], freq["G#3"], freq["C#4"], ] },
    { name: 'Drop A', notes: ['A1', 'E2', 'A2', 'D3', 'F♯3', 'B3'], values: [freq["A1"], freq["E2"], freq["A2"], freq["D3"], freq["F#3"], freq["B3"], ] },
  ],
  "Open": [
    { name: 'Open C', notes: ['C2', 'G2', 'C3', 'G3', 'C4', 'E4'], values: [freq["C2"], freq["G2"], freq["C3"], freq["G3"], freq["C4"], freq["E4"], ] },
    { name: 'Open E', notes: ['E2', 'B2', 'E3', 'G♯3', 'B3', 'E4'], values: [freq["E2"], freq["B2"], freq["E3"], freq["G#3"], freq["B3"], freq["E4"], ] },
    ...
    { name: 'Open A', notes: ['E2', 'A2', 'C♯3', 'E3', 'A3', 'E4'], values: [freq["E2"], freq["A2"], freq["C#3"], freq["E3"], freq["A3"], freq["E4"], ] },
    { name: 'Open A 2', notes: ['E2', 'A2', 'E3', 'A3', 'C♯4', 'E4'], values: [freq["E2"], freq["A2"], freq["E3"], freq["A3"], freq["C#4"], freq["E4"], ] },
    ...
    { name: 'Open D', notes: ['D2', 'A2', 'D3', 'F♯3', 'A3', 'D4'], values: [freq["D2"], freq["A2"], freq["D3"], freq["F#3"], freq["A3"], freq["D4"], ] },
    { name: 'Open Dm', notes: ['D2', 'A2', 'D3', 'F3', 'A3', 'D4'], values: [freq["D2"], freq["A2"], freq["D3"], freq["F3"], freq["A3"], freq["D4"], ] },
  ],
  "Extras": [
    { name: '-1', notes: ['D♯2', 'G♯2', 'C♯3', 'F♯3', 'A♯3', 'D♯4'], values: [freq["D#2"], freq["G#2"], freq["C#3"], freq["F#3"], freq["A#3"], freq["D#4"], ] },
    { name: '-2', notes: ['D2', 'G2', 'C3', 'F3', 'A3', 'D4'], values: [freq["D2"], freq["G2"], freq["C3"], freq["F3"], freq["A3"], freq["D4"], ] },
    { name: '+1', notes: ['F2', 'A♯2', 'D♯3', 'G♯3', 'C4', 'F4'], values: [freq["F2"], freq["A#2"], freq["D#3"], freq["G#3"], freq["C4"], freq["F4"], ] },
    { name: '+2', notes: ['F♯2', 'B2', 'E3', 'A3', 'C♯4', 'F♯4'], values: [freq["F#2"], freq["B2"], freq["E3"], freq["A3"], freq["C#4"], freq["F#4"], ] },
